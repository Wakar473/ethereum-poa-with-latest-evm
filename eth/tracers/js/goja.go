...
func (t *jsTracer) onStart(from common.Address, to common.Address, b bool, input []byte, gas uint64, value *big.Int) {
	panic("unimplemented")
}
...
func (t *jsTracer) CaptureStart(env *tracing.VMContext, from common.Address, to common.Address, create bool, input []byte, gas uint64, value *big.Int) {
	...
	gasPriceBig, err := t.toBig(t.vm, value.String())
	if err != nil {
		cancel(err)
		return
	}
